...
CREATE TABLE "new_VaccineAdministration" (
    ...
    "facilityType" TEXT,
    "otherVaccinesRecentGiven" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_VaccineAdministration" ("administeringFacility", "administrationDate", "administrationTime", "bodySite", "doseNumber", "facilityType", "id", "lotNumber", "manufacturer", "otherVaccinesRecent", "otherVaccinesSameVisit", "reportId", "route", "vaccine2BodySite", "vaccine2DoseNumber", "vaccine2Given", "vaccine2LotNumber", "vaccine2Manufacturer", "vaccine2Route", "vaccine2Type", "vaccineType", "vaccineTypeOther") SELECT "administeringFacility", "administrationDate", "administrationTime", "bodySite", "doseNumber", "facilityType", "id", "lotNumber", "manufacturer", "otherVaccinesRecent", "otherVaccinesSameVisit", "reportId", "route", "vaccine2BodySite", "vaccine2DoseNumber", "vaccine2Given", "vaccine2LotNumber", "vaccine2Manufacturer", "vaccine2Route", "vaccine2Type", "vaccineType", "vaccineTypeOther" FROM "VaccineAdministration";
